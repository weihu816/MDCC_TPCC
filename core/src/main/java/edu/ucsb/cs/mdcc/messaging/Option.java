...
;
  ...
  public int compareTo(Option other) {
    ...
    lastComparison = Boolean.valueOf(isSetClassic()).compareTo(other.isSetClassic());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClassic()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.classic, other.classic);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
